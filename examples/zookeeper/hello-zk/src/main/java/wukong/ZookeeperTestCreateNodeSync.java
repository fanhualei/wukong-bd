...
public class ZookeeperTestCreateNodeSync implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        String path1 = zooKeeper.create(PREFIX, "aaa".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
        System.out.println("success create znode:"+ path1);
        String path2 = zooKeeper.create(PREFIX, "bbb".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
